...
import { useRegisterAsProfessionalMutation } from "../../redux/features/auth/authApi";

const RegAsProfessional = () => {
    const [registrationAs, setRegistrationAs] = useState("");
    const [register, { data: response, isLoading, isError }] = useRegisterAsProfessionalMutation();
                                            ...
                                            <div className="o__register">
                                                ...
                                                <div className="option">
                                                    <div className="s-input nice-select-wraper">
                                                        <select
                                                            onChange={e => setRegistrationAs(e.target.value)}
